...
public class ActivityController {
         ...
         * Get all activities
         * 
         * @param top    Optional limit for results (default: 100)
        ...
        public ResponseEntity<ApiResponse<List<Activity>>> getActivitiesByStaff(
                ...
                try {
                        ...
                        return ResponseEntity.ok(ApiResponse.<List<Activity>>builder()
                                        .success(true)
                                        .message("Successfully retrieved " + activities.size()
                                                        + " activities for staff: " + email)
                                        .data(activities)
                                        .build());
                        ...
                        return ResponseEntity.internalServerError()
                                        .body(ApiResponse.<List<Activity>>builder()
                                                        .success(false)
                                                        .message("Failed to retrieve activities by staff: "
                                                                        + e.getMessage())
                                                        .build());
                }
        }
        ...
        public ResponseEntity<ApiResponse<List<Activity>>> getActivitiesByAccount(
                ...
                try {
                        ...
                        return ResponseEntity.internalServerError()
                                        .body(ApiResponse.<List<Activity>>builder()
                                                        .success(false)
                                                        .message("Failed to retrieve activities by account: "
                                                                        + e.getMessage())
                                                        .build());
                }
        }
        ...
        public ResponseEntity<ApiResponse<java.util.Map<String, java.util.Map<String, String>>>> getEmailDetails(
                ...
                try {
                        ...
                        return ResponseEntity
                                        .ok(ApiResponse.<java.util.Map<String, java.util.Map<String, String>>>builder()
                                                        .success(true)
                                                        .message("Successfully retrieved email details for "
                                                                        + emailDetails.size() + " activities")
                                                        .data(emailDetails)
                                                        .build());
        ...
        public ResponseEntity<ApiResponse<List<Activity>>> getSentEmailsByStaff(
                ...
                try {
                        ...
                        return ResponseEntity.ok(ApiResponse.<List<Activity>>builder()
                                        .success(true)
                                        .message("Successfully retrieved " + activities.size() + " sent emails for: "
                                                        + email)
                                        .data(activities)
                                        .build());
        ...
        public ResponseEntity<ApiResponse<List<Activity>>> getReceivedEmailsByStaff(
                ...
                try {
                        ...
                        return ResponseEntity.internalServerError()
                                        .body(ApiResponse.<List<Activity>>builder()
                                                        .success(false)
                                                        .message("Failed to retrieve received emails: "
                                                                        + e.getMessage())
                                                        .build());
                }
        }
        ...
        public ResponseEntity<ApiResponse<com.example.backend.model.EmailStats>> getEmailStats(
                ...
                try {
                        log.info("GET /api/activities/emails/stats/{} - FromDate: {}, ToDate: {}", email, fromDate,
                                        toDate);
        ...
        public ResponseEntity<ApiResponse<List<java.util.Map<String, Object>>>> getRecentActivities(
                        ...
                        @RequestParam(required = false) String toDate) {
                try {
                        log.info("GET /api/activities/recent - top: {}, fromDate: {}, toDate: {}", top, fromDate,
                                        toDate);

                        List<java.util.Map<String, Object>> activities = activityService.getRecentActivities(top,
                                        fromDate, toDate);
        ...
        public ResponseEntity<ApiResponse<List<com.example.backend.model.UnrepliedEmail>>> getUnrepliedEmails(
                ...
                try {
                        ...
                        return ResponseEntity.ok(ApiResponse.<List<com.example.backend.model.UnrepliedEmail>>builder()
                                        .success(true)
                                        .message("Successfully retrieved " + unrepliedEmails.size()
                                                        + " unreplied emails")
                        ...
                        return ResponseEntity.internalServerError()
                                        .body(ApiResponse.<List<com.example.backend.model.UnrepliedEmail>>builder()
                                                        .success(false)
                                                        .message("Failed to retrieve unreplied emails: "
                                                                        + e.getMessage())
                                                        .build());
                }
        }
        ...
        public ResponseEntity<ApiResponse<java.util.Map<String, Object>>> getOverallEmailStats(
                        ...
                        @RequestParam(required = false) String toDate) {
                try {
                        log.info("GET /api/activities/emails/overall-stats - FromDate: {}, ToDate: {}", fromDate,
                                        toDate);
